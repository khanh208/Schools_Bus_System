...
Run: python manage.py shell < scripts/init_db.py
"""
...
def create_sample_classes():
    ...
    classes_data = [
        {'name': '1A', 'grade_level': 1, 'academic_year': '2024-2025', 'teacher_name': 'Nguyễn Thị A'},
        {'name': '2A', 'grade_level': 2, 'academic_year': '2024-2025', 'teacher_name': 'Trần Văn B'},
        {'name': '3A', 'grade_level': 3, 'academic_year': '2024-2025', 'teacher_name': 'Lê Thị C'},
    ]
    ...
    try:
        ...
        if not Student.objects.filter(student_code='HS20240101').exists():
            Student.objects.create(
                ...
                pickup_location=Point(106.6297, 10.8231),  # Coordinates in HCMC
